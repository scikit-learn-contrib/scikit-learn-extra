...
estimators = [('SGDClassifier, Hinge loss', SGDClassifier(loss="hinge")),
              ('SGDClassifier, log loss', SGDClassifier(loss="log")),
              ('SGDClassifier, modified_huber loss',
               SGDClassifier(loss="modified_huber")),
              ('RobustWeightedEstimator',
               RobustWeightedEstimator(base_estimator=SGDClassifier(),
                                       loss='log', weighting='huber'))]
...
plt.suptitle('Scatter plot of training set and representation of'
